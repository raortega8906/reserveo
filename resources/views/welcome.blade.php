...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white text-black flex min-h-screen flex-col">
        ...
        <!-- Features Section (Fondo Gris Oscuro) -->
        <section id="features" class="py-16 bg-gray-800 text-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gray-700 p-6 rounded-lg shadow-sm border border-gray-600">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-2">{{ __('Informes y estadísticas') }}</h3>
                        <p class="text-gray-300">
                    ...
                    <div class="bg-gray-700 p-6 rounded-lg shadow-sm border border-gray-600">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-2">{{ __('Pagos en línea') }}</h3>
                        <p class="text-gray-300">
                    ...
                    <div class="bg-gray-700 p-6 rounded-lg shadow-sm border border-gray-600">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-2">{{ __('Reservas móviles') }}</h3>
                        <p class="text-gray-300">
        ...
        <!-- How It Works Section (Fondo Blanco) -->
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl font-bold text-black mb-4">{{ __('¿Cómo funciona?') }}</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center">
                        <div class="w-16 h-16 bg-white border-2 border-black rounded-full flex items-center justify-center mx-auto mb-4">
                            <span class="text-xl font-bold text-black">1</span>
                        </div>
                        <h3 class="text-xl font-semibold text-black mb-2">{{ __('Regístrate') }}</h3>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-semibold text-black mb-2">{{ __('Personaliza') }}</h3>
                        <p class="text-gray-600">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-semibold text-black mb-2">{{ __('¡Listo!') }}</h3>
                        <p class="text-gray-600">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('register') }}" class="rounded-md bg-white px-6 py-3 text-base font-medium text-gray-800 hover:bg-gray-100">
                            {{ __('Crear cuenta gratis') }}
                        </a>
                        <a href="#" class="rounded-md border border-gray-400 px-6 py-3 text-base font-medium text-white hover:bg-gray-600">
                            {{ __('Solicitar demo') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-2">
                            ...
                            <li><a href="#" class="text-gray-600 hover:text-gray-900">{{ __('Testimonios') }}</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-2">
                            <li><a href="#" class="text-gray-600 hover:text-gray-900">{{ __('Contacto') }}</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-900">{{ __('Documentación') }}</a></li>
                            <li><a href="#" class="text-gray-600 hover:text-gray-900">{{ __('Política de privacidad') }}</a></li>
                        </ul>
                    </div>
                </div>
